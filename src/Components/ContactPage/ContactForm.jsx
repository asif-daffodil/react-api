        ...
        <div className="overflow-hidden shadow-[0_2px_10px_-3px_rgba(6,81,237,0.3)] rounded-3xl max-w-6xl mx-auto bg-white m-4 font-[sans-serif]">
            <div
                ...
                <div className="p-8 bg-gray-900">
                    <h2 className="text-3xl text-white">Get In <span className="text-yellow-400">Touch</span></h2>
                    <p className="text-sm text-gray-400 mt-4 leading-relaxed">Have a specific inquiry or looking to explore new opportunities? Our
